...
class PluginProcessorSpec extends Specification {
    ...
    def 'test filterSupportingData, two match from km'() {
        ...
        Map<String, SupportingData> supportingData = [
                'sd1': SupportingData.create('sd1', 'kmid', null, 'package1', 'type', new Date(), () -> SupportingDataPackage.create(() -> null, () -> null)),
                'sd2': SupportingData.create('sd2', 'kmid', null, 'package2', 'type', new Date(), () -> SupportingDataPackage.create(() -> null, () -> null)),
                'sd3': SupportingData.create('sd3', 'kmid', null, 'package3', 'type', new Date(), () -> SupportingDataPackage.create(() -> null, () -> null)),
                'sd4': SupportingData.create('sd4', 'kmid', null, 'package4', 'type', new Date(), () -> SupportingDataPackage.create(() -> null, () -> null)),
                'sd5': SupportingData.create('sd5', 'kmid', null, 'package5', 'type', new Date(), () -> SupportingDataPackage.create(() -> null, () -> null))
        ]
    ...
    def 'test filterSupportingData, two match loadedBy'() {
        ...
        Map<String, SupportingData> supportingData = [
                'sd1': SupportingData.create('sd1', 'kmid', EntityIdentifierUtil.makeEIString(left), 'package1', 'type', new Date(), () -> SupportingDataPackage.create(() -> null, () -> null)),
                'sd2': SupportingData.create('sd2', 'kmid', null, 'package2', 'type', new Date(), () -> SupportingDataPackage.create(() -> null, () -> null)),
                'sd3': SupportingData.create('sd3', 'kmid', null, 'package3', 'type', new Date(), () -> SupportingDataPackage.create(() -> null, () -> null)),
                'sd4': SupportingData.create('sd4', 'kmid', null, 'package4', 'type', new Date(), () -> SupportingDataPackage.create(() -> null, () -> null)),
                'sd5': SupportingData.create('sd5', 'kmid', EntityIdentifierUtil.makeEIString(left), 'package5', 'type', new Date(), () -> SupportingDataPackage.create(() -> null, () -> null))
        ]
        PluginIdTuple tuple = PluginIdTuple.create(left, right)
    ...
    def 'test filterSupportingData, no match loadedBy'() {
        ...
        PrePostProcessPluginId right = PrePostProcessPluginIdImpl.create('scopingEID', 'businessID', 'version', [])
        Map<String, SupportingData> supportingData = [
                'sd1': SupportingData.create('sd1', 'kmid', EntityIdentifierUtil.makeEIString(PluginIdImpl.create('scopingEID2', 'businessID2', 'version2')), 'package1', 'type', new Date(), () -> SupportingDataPackage.create(() -> null, () -> null)),
                'sd2': SupportingData.create('sd2', 'kmid', null, 'package2', 'type', new Date(), () -> SupportingDataPackage.create(() -> null, () -> null)),
                'sd3': SupportingData.create('sd3', 'kmid', null, 'package3', 'type', new Date(), () -> SupportingDataPackage.create(() -> null, () -> null)),
                'sd4': SupportingData.create('sd4', 'kmid', null, 'package4', 'type', new Date(), () -> SupportingDataPackage.create(() -> null, () -> null)),
                'sd5': SupportingData.create('sd5', 'kmid', EntityIdentifierUtil.makeEIString(PluginIdImpl.create('scopingEID2', 'businessID2', 'version2')), 'package5', 'type', new Date(), () -> SupportingDataPackage.create(() -> null, () -> null))
        ]
        PluginIdTuple tuple = PluginIdTuple.create(left, right)
