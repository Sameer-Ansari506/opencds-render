...
public class EvaluationContext {
    ...
    private EvaluationContext(String focalPersonId,
                              Date evalTime,
                              URI serverBaseUri,
    ...
    public static EvaluationContext create(EvaluationRequestKMItem evaluationRequestKMItem,
                                           String primaryProcess) {
        EvaluationRequestDataItem evalRequestDataItem = evaluationRequestKMItem.getEvaluationRequestDataItem();
        // TODO: validate input
        return new EvaluationContext(
                evalRequestDataItem.getFocalPersonId(),
                evalRequestDataItem.getEvalTime(),
                evalRequestDataItem.getServerBaseUri(),
                evalRequestDataItem.getClientLanguage(),
                evalRequestDataItem.getClientTimeZoneOffset(),
                ConcurrentHashMap.newKeySet(),
                new ConcurrentHashMap<>(),
                new ConcurrentHashMap<>(),
                evaluationRequestKMItem.getAllFactLists(),
                primaryProcess);
    }
