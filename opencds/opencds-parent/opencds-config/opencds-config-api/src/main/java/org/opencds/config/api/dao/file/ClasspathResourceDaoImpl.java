...
public class ClasspathResourceDaoImpl implements FileDao {
    ...
    public ClasspathResourceDaoImpl(ResourceUtil resourceUtil, Path location) {
...
//    	String path = location + CLASSPATH_SEPARATOR + pk;
    	log.debug("Finding cache element at: " + location.toString());
        return StreamCacheElement.create(pk, resourceUtil.getResourceAsStream(location.toString()));
    }
