...
public class DroolsExecutionEngineAdapter implements ExecutionEngineAdapter<Map<Class<?>, List<?>>, Map<Class<?>, List<?>>, InputStream> {
    ...
    private static String buildDrl() {
        ...
        sb.append("        dx.setProblemCode(dxc); dx.setToBeReturned(true); insert(dx);\n");
        sb.append("        SubstanceAdministrationProposal ab = new SubstanceAdministrationProposal(); CD mc = new CD();\n");
        sb.append("        mc.setCode(\"7454\"); mc.setCodeSystem(\"RxNorm\"); mc.setDisplayName(\"Nitrofurantoin (Macrobid) - first-line antibiotic for uncomplicated UTI\");\n");
        sb.append("        ab.setAdministrableSubstance(mc); ab.setToBeReturned(true); insert(ab);\n");
        sb.append("end\n");
        ...
        sb.append("        dx.setProblemCode(dxc); dx.setToBeReturned(true); insert(dx);\n");
        sb.append("        SubstanceAdministrationProposal med = new SubstanceAdministrationProposal(); CD mc = new CD();\n");
        ...
        sb.append("        med.setAdministrableSubstance(mc); med.setToBeReturned(true); insert(med);\n");
        sb.append("end\n");
        ...
        sb.append("        med.setAdministrableSubstance(mc); med.setToBeReturned(true); insert(med);\n");
        sb.append("        SubstanceAdministrationProposal med2 = new SubstanceAdministrationProposal(); CD mc2 = new CD();\n");
        ...
        sb.append("        med2.setAdministrableSubstance(mc2); med2.setToBeReturned(true); insert(med2);\n");
        sb.append("end\n");
